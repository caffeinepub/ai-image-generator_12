...
export class Backend implements backendInterface {
    ...
    async deleteGenerationRecord(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteGenerationRecord(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllGenerationRecords(): Promise<Array<GenerationRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllGenerationRecords();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveGenerationRecord(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveGenerationRecord(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
